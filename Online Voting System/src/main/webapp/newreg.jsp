...
<input type="radio" id="male" name="gender" value="M"style="margin-left: 75px;">
...
<input name = "add" id = "add" type = "text" style="margin-left:160px;height:70px; width:200px;text-align:left; margin-top:8px;">
<br>
...
<br>
<button type = "submit" Style="margin-left:220px;">Submit</button>
